...
Every pull-request merged to main updates the workflow file [create-release-tag.yml](./workflows/create-release-tag.yml). The associated action ensures all merges are released and updates the latest major version tag (i.e. v46).
